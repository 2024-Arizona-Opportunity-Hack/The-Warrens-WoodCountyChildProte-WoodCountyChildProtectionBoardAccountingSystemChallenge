...
const monthlyFundingData = [
	{ month: "Jan", funding: 4000 },
	{ month: "Feb", funding: 3000 },
	{ month: "Mar", funding: 5000 },
	{ month: "Apr", funding: 4500 },
	{ month: "May", funding: 6000 },
	{ month: "Jun", funding: 5500 },
	{ month: "Jul", funding: 7000 },
];
	...
	return (
		...
		>
			<div className='flex items-center justify-between mb-6'>
				<h2 className='text-xl font-semibold text-gray-100'>Funding Overview</h2>
			...
			<div className='w-full h-[400px]'>
				<ResponsiveContainer width="100%" height="100%">
					<AreaChart data={monthlyFundingData}>
